...
const travelClasses = [
  ...
  { id: 2, name: "Premium economy", value: "premium-economy" },
  { id: 3, name: "Business", value: "business" },
  { id: 4, name: "First", value: "first-class" },
];

const TravelClass = ({ value, onChange }) => {
  ...
  return (
    ...
    >
      <div className="relative z-20" ref={dropdownRef}>
        ...
        >
          {travelClasses.find((cls) => cls.value === value)?.name}
